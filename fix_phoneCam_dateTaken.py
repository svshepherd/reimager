# -*- coding: utf-8 -*-
"""
Created on Wed Jul 24 16:45:55 2019

@author: svs
"""

'''the purpose of this program is to fix the damned stupid fact that my camera 
images, saved via Seek rather than the camera roll, keep geotagging but 
mysteriously lose timestamps! note that *if* this works, it only works
for very basic Exif data'''
